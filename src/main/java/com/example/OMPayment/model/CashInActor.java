...
@Data
@Entity
@Table(name = "TD_CashInActor")
@AllArgsConstructor
@NoArgsConstructor
@XmlRootElement
public class CashInActor implements Serializable {
    @Id
    ...
    public CashInActor(String msisdn, Long pinCode, Long merchantCode, String type, String grade, Date expiresAt) {
        this.msisdn = msisdn;
